...
export default function NowPlaying() {
  ...
  const nav = useNav();
  const { activeGroup, activeTrack, roomName, groupVol, groupMuted, volumeSettling, isLiked, config, seek, setActiveVol, toggleLike, queueFor, clearQueue, reorderQueue } = store;
